...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xjavascript " << XEUS_JAVASCRIPT_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xjavascript
    ...
    using interpreter_ptr = std::unique_ptr<xeus_javascript::interpreter>;
    interpreter_ptr interpreter = interpreter_ptr(new xeus_javascript::interpreter());
